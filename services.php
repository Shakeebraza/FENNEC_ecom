...
<div class="container mt-4 mb-5">
        <div class="row">
            <div class="col-12 d-flex justify-content-between mb-4">
                <div>
                    <h1 class="jobhead">28,276 ads Services</h1>
              ...
              <div class="mb-2 p-3 sale-loc">
                  ...
                  <div class="ms-3">
                      <div class="custom-category">
                          <p>Tradesmen & Construction</p>
                      </div>
                      <div class="custom-category">
                          <p>Transport<span class="text-muted">(5637)</span></p>
                      </div>
                      <div class="custom-category">
                          <p>Health & Beauty<span class="text-muted">(4516)</span></p>
                      </div>
                      <div class="custom-category">
                          <p>Property & Maintenance <span class="text-muted">(4270)</span></p>
                      </div>
                  </div>
                  <div class="more-categories" id="moreCategories" style="display: none;">
                      <div class="ms-3 mt-2">
                          <div class="custom-category">
                              <p>Tuition & Classes <span class="text-muted">(3147)</span></p>
                          </div>
                          <div class="custom-category">
                              <p>Motoring <span class="text-muted">(3070)</span></p>
                          </div>
                          <div class="custom-category">
                              <p>Weddings <span class="text-muted">(3147)</span></p>
                          </div>
                          <div class="custom-category">
                              <p>Business & Office <span class="text-muted">(3070)</span></p>
                          </div>
                          <div class="custom-category">
                              <p>Computers & Telecoms<span class="text-muted">(2365)</span></p>
                          </div>
                      </div>
                  </div>
