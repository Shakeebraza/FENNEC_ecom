...
<div class="container mt-4 mb-5">
        <div class="row">
            <div class="col-12 d-flex justify-content-between mb-4">
                <div>
                    <h1 class="jobhead">47,962 ads Property</h1>
                ...
                >
                  ...
                  <div class="col">
                    <div class="product-card">
                      <img
                        src="https://imagedelivery.net/ePR8PyKf84wPHx7_RYmEag/860fb0ec-4335-4122-8135-00c9fe7e5600/86"
                        class="card-img-top"
                      ...
                      <div class="card-body">
                        <div class="p-3">
                          <h5 class="card-title">Exquisite ONE Bed Apartment</h5>
                          <p class="card-text">
                            Private Date available:<br> 12 Oct 2024 | Flat | 1 Bed
                          </p>
                  ...
                  <div class="col">
                    <div class="product-card">
                      <img
                        src="https://imagedelivery.net/ePR8PyKf84wPHx7_RYmEag/48214087-96f5-4e25-07f4-8cd52c2cd100/86"
                        class="card-img-top"
                        alt="Classic Maroon Kameez Shalwar"
                      />
                      <div class="discount-badge">-25%</div>
                  ...
                  <div class="col">
                    <div class="product-card">
                      <img
                        src="https://imagedelivery.net/ePR8PyKf84wPHx7_RYmEag/b452d3f9-479c-4a9e-3dad-66d394d48700/86"
                        class="card-img-top"
                        alt="Classic Maroon Kameez Shalwar"
                      />
                      <div class="discount-badge">-25%</div>
            ...
            <div class="col-md-3 p-3 mb-5 sale-loc left-side">
              ...
              <div class="mb-2 p-3 sale-loc">
                  ...
                  <div class="ms-3">
                      ...
                      <div class="custom-category">
                          <p>For Sale <span class="text-muted">(5637)</span></p>
                      </div>
                      <div class="custom-category">
                          <p>Commercial  <span class="text-muted">(4516)</span></p>
                      </div>
                      <div class="custom-category">
                          <p>To Share <span class="text-muted">(4270)</span></p>
                      </div>
                      <div class="custom-category">
                          <p>Parking & Garage <span class="text-muted">(3147)</span></p>
                      </div>
                      <div class="custom-category">
                          <p>Property Wanted <span class="text-muted">(3070)</span></p>
                      </div>
                  </div>
                  <div class="more-categories" id="moreCategories" style="display: none;">
                      <div class="ms-3 mt-2">
                          <div class="custom-category">
                              <p>To Swap <span class="text-muted">(2911)</span></p>
                          </div>
                          <div class="custom-category">
                              <p>Holiday Rentals <span class="text-muted">(2371)</span></p>
                          </div>
                          <div class="custom-category">
                              <p>International<span class="text-muted">(2365)</span></p>
                          </div>
                      </div>
                  </div>
