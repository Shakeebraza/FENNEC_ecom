          ...
          <div class="card-body">
            <form id="productForm" enctype="multipart/form-data">
              ...
              <div class="mb-3">
                ...
                <input type="text" class="form-control" id="title" name="productName" placeholder="<?= $lan['enter'] . ' ' . $lan['product_title'] ?>" required />
              </div>
              ...
              <div class="mb-3">
                ...
                <div class="form-check">
                  ...
                  <label class="form-check-label" for="conditionNew"><?= $lan['new_condition'] ?></label>
                </div>
                <div class="form-check">
                  <input class="form-check-input" type="radio" name="condition" id="conditionUsed" value="used" required />
                  <label class="form-check-label" for="conditionUsed"><?= $lan['used_condition'] ?></label>
                </div>
              </div>
              ...
              <div class="mb-3">
                ...
                <input type="number" class="form-control" name="price" id="price" placeholder="<?= $lan['enter'] . ' ' . $lan['price'] ?>" required />
              </div>
              ...
              <div class="mb-3">
                ...
                <textarea class="form-control" id="description" rows="3" name="description" placeholder="<?= $lan['describe_your_product'] ?>" required></textarea>
              </div>

              <!-- Brand -->
              <div class="mb-3">
                <label for="brand" class="form-label"><?= $lan['brand'] ?></label>
                <input type="text" class="form-control" id="brand" name="brand" placeholder="<?= $lan['enter'] . ' ' . $lan['brand'] ?>" required />
              </div>
              ...
              <!-- City -->
              <div class="mb-3">
                <label for="city" class="form-label"><?= $lan['city'] ?> <span style="color: red;">*</span></label>
              ...
              <!-- Submit Button -->
              <button type="submit" class="btn btn-success float-end"><?= $lan['publish_listing'] ?></button>
            </form>
            ...
            <div id="passwordModal" class="modal" style="display: none;">
              <div class="modal-content">
                ...
                <form id="passwordForm" onsubmit="updatePassword(event)">
                  ...
                  <div class="mb-3">
                    <label for="confirmPassword" class="form-label"><?= $lan['confirm_password']?></label>
