    ...
    <div class="container mt-4 mb-5">
        <div class="row">
            <div class="col-12 d-flex justify-content-between mb-4">
                <div>
                    <h1 class="jobhead">12,717 ads Pets & Pet Equipment for Sale</h1>
            ...
            <div class="col-md-3 p-3 mb-5 sale-loc left-side">
              ...
              <div class="mb-2 p-3 sale-loc">
                  ...
                  <div class="ms-3">
                      ...
                      <div class="custom-category">
                          <p>Equipment & Accessories <span class="text-muted">(5637)</span></p>
                      </div>
                      <div class="custom-category">
                          <p>Missing, Lost & Found <span class="text-muted">(4516)</span></p>
                      </div>
                  </div>
              </div>
          </div>
